...
type DefaultRecipeConfig<T extends RecipeVariantRecord = RecipeVariantRecord> = RecipeDefinition<T> & RecipeConfigMeta

export type RecipeConfig<T extends RecipeVariantRecord = RecipeVariantRecord> =
  IsEmptyInterface<StyledRecipeConfig> extends true ? DefaultRecipeConfig<T> : StyledRecipeConfig
